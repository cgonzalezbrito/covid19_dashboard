...
ui <- fluidPage(
  title = "COVID-19 Datos en Ecuador - Open Source Version",
  tags$head(
  ...
  navbarPage(
    title       = div("COVID-19 Datos en Ecuador - Open Source Version", style = "padding-left: 10px"),
    collapsible = TRUE,
    fluid       = TRUE,
    ...
    header.append('<div style=\"float:right\"><img src=\"xrlab.png\" alt=\"alt\" style=\"float:left;width:100px;padding-top:10px;margin-top:-50px;margin-right:10px\"><img src=\"logo_institucion.png\" alt=\"alt\" style=\"float:left;width:150px;padding-top:10px;margin-top:-50px;margin-right:10px\"> </div>');
    header.append('<div style=\"float:right\">Powered by: </div>');  
    console.log(header)")
    )
  )
)